...
| Profile                             | sparse | chunk\_size | overlap | HyDE variant                |
| ----------------------------------- | ------ | ----------- | ------- | --------------------------- |
...
#### cache\_hit\_rate.js — Semantic Cache Warmup
...
#### keyword\_baseline.js — Keyword vs Hybrid Delta
...
#### ollama\_embed\_throughput.js — Embedder Saturation
